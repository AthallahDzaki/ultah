...
let from = url.searchParams.get('by') ? : "AthallahDzaki";
let to = url.searchParams.get('to') ? : "AthallahDzaki";
let tgl = url.searchParams.get('tgl');
let bln = url.searchParams.get('bln');
let thn = url.searchParams.get('thn');

const second = 1000,
  minute = second * 60,
  hour = minute * 60,
  day = hour * 24;
let time = `$bln $tgl, $thn 00:00:00`;
